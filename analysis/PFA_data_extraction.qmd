...
save(ls_1996, file = paste0(output_dir, "ls_1996_April11.Rdata"))
save(ls_2007, file = paste0(output_dir, "ls_2007_April11.Rdata"))
save(ls_2011, file = paste0(output_dir, "ls_2011_April11.Rdata"))
save(nonls_1996, file = paste0(output_dir, "nonls_1996_April11.Rdata"))
save(nonls_2007, file = paste0(output_dir, "nonls_2007_April11.Rdata"))
save(nonls_2011, file = paste0(output_dir, "nonls_2011_April11.Rdata"))
```
