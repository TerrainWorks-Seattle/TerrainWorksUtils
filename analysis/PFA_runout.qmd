...
multiLog$model
```
Use [package iml](https://cran.r-project.org/web/packages/iml/vignettes/intro.html) to explore model behavior.
...
```
This model behaves as we might expect; how much confidence can we place in predictions? 
Use mlr3 resampling strategies here - I'll get to this.
